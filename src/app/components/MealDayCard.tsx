    ...
    return (
      <div className="border border-gray-200 rounded-lg overflow-hidden">
        <div className="bg-gray-100 text-gray-400 text-center py-2 font-medium">
          {day}요일 <span className="text-base text-gray-400">({dateLabel})</span>
        </div>
  ...
  return (
    <div className="border border-gray-200 rounded-lg overflow-hidden">
      ...
      <div className="bg-[#5dccb4] text-white text-center py-2 font-medium">
        {day}요일 <span className="text-base text-white/80">({dateLabel})</span>
      </div>
        ...
        <div className="p-4 flex flex-col">
          ...
          <div className="pb-4 border-b border-gray-200 flex flex-col">
            <div className="h-6 mb-2 flex items-center justify-between flex-shrink-0">
              <span className="inline-block px-2 py-1 bg-orange-100 text-orange-700 text-sm rounded">
                중식
              </span>
            </div>
          <div className="text-base text-gray-800 leading-relaxed space-y-1 flex-1 mb-2">
                  ...
                  {item.name ? (
                    <>
                      ...
                      {item.allergy && item.allergy.length > 0 && (
                        <span className="text-base text-gray-600 bg-[#FCE8E6] px-1 py-0.5 rounded flex-shrink-0">
                          {item.allergy.join(',')}
                        </span>
                      )}
                    </>
            ...
            <button
              ...
              className="flex items-center justify-center gap-1 py-1.5 text-base text-gray-600 hover:text-[#5dccb4] hover:bg-[#5dccb4]/5 rounded transition-colors flex-shrink-0 disabled:text-gray-300"
