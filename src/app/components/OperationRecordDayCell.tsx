...
export function OperationRecordDayCell({
  ...
  return (
    ...
    >
      <span className="text-base font-medium absolute top-2 left-2">{dateLabel}</span>
      {record && (
        <span className="absolute top-2 right-2 text-[12px] px-2 py-0.5 rounded-full bg-[#5dccb4]/10 text-[#2f9b88]">
          기록됨
        </span>
      )}
      {dayNum !== null && (
        <div className="mt-6 space-y-4">
          {hasLunch && (
            <div className="rounded-md border border-gray-200 bg-gray-50 p-2 space-y-2">
              <div className="text-[12px] font-semibold text-gray-500">중식</div>
              <div className="text-[14px] text-gray-700 leading-4">
          ...
          {hasDinner && (
            <div className="rounded-md border border-gray-200 bg-gray-50 p-2 space-y-2">
              <div className="text-[12px] font-semibold text-gray-500">석식</div>
              <div className="text-[14px] text-gray-700 leading-4">
