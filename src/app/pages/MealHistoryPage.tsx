      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <div className="flex gap-4 mb-6">
          <div className="flex-[2]">
            <label className="block text-base font-medium mb-2">조회 기간</label>
          ...
          <div className="flex-1">
            <label className="block text-base font-medium mb-2">작업 유형</label>
            <select 
              className="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-[#5dccb4]"
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b-2 border-gray-300">
                <th className="text-left py-3 px-4 text-xl">수정 일시</th>
                <th className="text-left py-3 px-4 text-xl">식단 날짜</th>
                <th className="text-center py-3 px-2 text-xl">작업</th>
                <th className="text-left py-3 px-2 text-xl">메뉴 (변경 전)</th>
                <th className="text-left py-3 px-2 text-xl">메뉴 (변경 후)</th>
                <th className="text-left py-3 px-2 text-xl">변경 내용</th>
              </tr>
            </thead>
            <tbody>
              {history.length === 0 ? (
                ...
                history.map((item, idx) => (
                  <tr key={idx} className="border-b border-gray-200 hover:bg-gray-50">
                    <td className="py-3 px-4 text-base">{item.date}</td>
                    ...
                    <td className="py-3 px-2 text-center">
                      <span className={`inline-block px-2 py-1 rounded text-base ${
                        item.action === '수정 (AI대체)'
                    ...
                    <td className="py-3 px-2 text-base text-gray-600 align-middle">
